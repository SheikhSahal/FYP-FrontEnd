...
let tagline = <span style={{ color: "red" }}>FTIM</span>;
    ...
    <div>
      ...
      {/* <div className="poster-abt">
       ...
       <div className="about">
        ...
        <Link to ={routes.ABOUT}><Button variant ="primary" style={{background:'lightblue',width:'40%',height:'2000%',position:'relative',boxShadow: 'inset 0 0.2 0.2 0.8 grey'}}>Testimonials
        </Button></Link>
    </div>
      </div> */}
    </div>
